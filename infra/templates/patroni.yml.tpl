...
restapi:
  ...
  certfile: /run/secrets/patroni-server.crt
  keyfile: /run/secrets/patroni-server.key
  cafile: /run/secrets/ca.crt
  verify_client: required

etcd3:
  hosts: https://hk.mlmll.cn:2379,https://sg.mlmll.cn:2379,https://us.mlmll.cn:2379
  protocol: https
